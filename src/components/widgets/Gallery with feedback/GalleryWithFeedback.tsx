      ...
      <div className="flex w-full flex-row items-center justify-between font-medium">
        ...
        <div className="flex flex-row gap-32">
          <Link
            ...
            target="_blank"
          >
            <Image src={responseYandex as unknown as string} alt="yandex_picture" width={100} height={100} />
          ...
          <Link className="flex flex-row items-baseline gap-5" href="#" target="_blank">
            <Image src={responseOtzovik as unknown as string} alt="otzovik_picture" width={100} height={100} />
